...
function cacheFunction(cb) {
  ...
  Tu tarea aquí es lograr, mediante un closure, que cacheFunction actúe como 
  una memoria caché para el callback que recibe por parámetro (cb); es decir, 
  que "recuerde" el resultado de cada operación que hace, de manera que, al realizar 
  una operación por segunda vez, se pueda obtener el resultado de esa "memoria" sin 
  tener que efectuar otra vez cálculos que ya se hicieron anteriormente.
  ...
  caché cuál es el resultado de square(5) y lo retornará (tip: si usaste un objeto,
     podés usar hasOwnProperty) 
  */
   var objeto = { } // objeto  me guarda los argumentos y sus resultados.
   return function(arg){
  if (objeto.hasOwnProperty (arg)) 
  return objeto[arg]; //busca en el objeto si ya esta el argumento si 
                                                      //esta (true) lo retorna sino esta
  else objeto[arg]= cb (arg); //me guarda el resultado de objeto en objeto
  
    return objeto[arg] //retorna el callback con el resultado.
...
/*
  ...
  continuación, tres funciones que retornen una cadena (string) y el delimitador especificado
   (asteriscos, guiones, y guiones bajos, respectivamente). Las funciones obtenidas deberían 
   recibir solamente un argumento - la cadena de texto - ya que los otros argumentos habrán 
   sido "bindeados". 
*/
...
/* console.log(textoAsteriscos("mane"))
Console.log(textoGuiones("magdalena"))
console.log(textoUnderscore("nidea")) */
